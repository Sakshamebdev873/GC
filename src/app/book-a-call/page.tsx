        ...
        <div className="mt-12">
          {site.calendlyUrl ? (
            ...
            <div className="rounded-2xl border border-dashed border-border bg-surface p-10 text-center">
              <p className="font-semibold text-primary">Scheduling isn&apos;t connected yet</p>
              ...
              <p className="mt-4 text-sm text-muted">
                ...
                <a href={`mailto:${site.email}`} className="font-medium text-accent-dark hover:underline">
                  {site.email}
                </a>{" "}
