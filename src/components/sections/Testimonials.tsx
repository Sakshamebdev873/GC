    ...
    <section className="py-20 sm:py-24">
      <Container>
        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-3">
          {featured && (
            <figure className="flex flex-col justify-between rounded-[28px] bg-primary p-10 text-white sm:p-12 lg:col-span-2">
          ...
          <div className="flex flex-col gap-6">
            {rest.map((t) => (
              <figure
                key={t.name}
                className="flex flex-1 flex-col rounded-2xl border border-border bg-white p-6"
              >
